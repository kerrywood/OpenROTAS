...
def LoadDllMainDll():
   ...
   dllObj.TestInterface.argtypes = [c_char, c_char_p, c_int, c_int_p, c_longlong, c_longlong_p, c_double, c_double_p, c_char_p, c_char_p, c_int * 3, c_int * 3, c_longlong * 3, c_longlong * 3, c_double * 3, c_double * 3, c_void_p, c_void_p, c_void_p, c_void_p, c_void_p, c_void_p]
   ...
   dllObj.TestInterface2.argtypes = [c_char_p, c_int_p, c_longlong_p, c_double_p, c_char_p, c_int * 3, c_longlong * 3, c_double * 3, c_void_p, c_void_p, c_void_p]
