...
def LoadExtEphemDll():
   ...
   dllObj.ExtEphGetAllFields.argtypes = [c_longlong, c_int_p, c_char_p, c_char_p, c_double_p, c_double_p, c_double_p, c_double * 3, c_double * 3, c_int_p, c_int_p, c_char_p]
   ...
   dllObj.ExtEphDs50UTCCovMtx.argtypes = [c_longlong, c_double, c_double_p, c_double * 3, c_double * 3, c_int_p, c_void_p]
