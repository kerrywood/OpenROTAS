...
def LoadObsDll():
   ...
   dllObj.ObsAddFrFields.argtypes = [c_char, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_int, c_int, c_int, c_int, c_double * 3, c_double * 3, c_double * 128]
   ...
   dllObj.ObsAddFrFieldsML.argtypes = [c_char, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_int, c_int, c_int, c_int, c_double * 3, c_double * 3, c_double * 128, c_longlong_p]
   ...
   dllObj.ObsGetAllFields.argtypes = [c_longlong, c_char_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_char_p, c_int_p, c_int_p, c_int_p, c_int_p, c_double * 3, c_double * 3, c_double * 128]
   ...
   dllObj.ObsUpdateFrFields.argtypes = [c_longlong, c_char, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_int, c_int, c_int, c_int, c_double * 3, c_double * 3, c_double * 128]
   ...
   dllObj.ObsFieldsToB3Card.argtypes = [c_char, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_int, c_int, c_int, c_int, c_double * 3, c_char_p]
   ...
   dllObj.ObsFieldsToCsv.argtypes = [c_char, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_int, c_int, c_int, c_int, c_double * 3, c_char_p]
   ...
   dllObj.ObsFieldsToTTYCard.argtypes = [c_char, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_double, c_char, c_double * 3, c_char_p, c_char_p]
   ...
   dllObj.ObsB3Parse.argtypes = [c_char_p, c_char_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_char_p, c_int_p, c_int_p, c_int_p, c_int_p, c_double * 3]
