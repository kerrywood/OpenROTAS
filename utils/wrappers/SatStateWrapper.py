...
def LoadSatStateDll():
   ...
   dllObj.SatStateGetSatDataAll.argtypes = [c_longlong, c_int_p, c_char_p, c_int_p, c_int_p, c_double_p, c_double_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p]
   ...
   dllObj.SatStateMse.argtypes = [c_longlong, c_double, c_double_p, c_int_p, c_double * 3, c_double * 3, c_double * 3]
   ...
   dllObj.SatStateDs50UTC.argtypes = [c_longlong, c_double, c_double_p, c_int_p, c_double * 3, c_double * 3, c_double * 3]
   ...
   dllObj.SatStateEphCom.argtypes = [c_longlong, c_longlong, c_double, c_int, c_double * 100]
   ...
   dllObj.SatStateEphCom_OS.argtypes = [c_double * 6, c_double * 6, c_double, c_int, c_double * 100]
   ...
   dllObj.SatStateGenEphFile.argtypes = [c_longlong, c_double, c_double, c_double, c_char_p, c_int]
   ...
   dllObj.GetGobsParams.argtypes = [c_longlong, c_double, c_double * 32, c_int_p]
   ...
   # xa_gobs_delta: The resulting gobs comparison deltas, see XA_GOBS_DELTA? for array arrangement (out-Double[32])
   dllObj.GobsCom.restype = c_int
   dllObj.GobsCom.argtypes = [c_longlong, c_longlong, c_double, c_double * 16, c_double * 32]
   ...
   dllObj.GobsComArr.argtypes = [c_double * 32, c_double * 32, c_double * 16, c_double * 16]
