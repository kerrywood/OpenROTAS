...
def LoadSensorDll():
   ...
   dllObj.SensorGet1L.argtypes = [c_longlong, c_char_p, c_char_p, c_int_p, c_double_p, c_char_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_int_p, c_int_p, c_double_p, c_int_p, c_double_p]
   ...
   dllObj.SensorSet1L.argtypes = [c_longlong, c_char, c_char, c_int, c_double, c_char, c_double, c_double, c_double, c_double, c_double, c_int, c_int, c_int, c_double, c_int, c_double]
   ...
   dllObj.SensorGet2L.argtypes = [c_longlong, c_char_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p]
   ...
   dllObj.SensorSet2L.argtypes = [c_longlong, c_char, c_double, c_double, c_double, c_double, c_int, c_double, c_double, c_double, c_double, c_double]
