...
def LoadSgp4PropDll():
   ...
   dllObj.Sgp4PosVelToKep.argtypes = [c_int, c_double, c_double * 3, c_double * 3, c_double * 3, c_double * 3, c_double * 6]
   ...
   # pos: Input osculating position vector (km). (in-Double[3])
   # vel: Input osculating velocity vector (km/s). (in-Double[3])
   # xa_tle: Input/Output array containing TLE's numerical fields, see XA_TLE_? for array arrangement; required data include epoch, ephemType, drag, bstar/bterm (inout-Double[64])
