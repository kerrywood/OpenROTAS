...
def LoadSpVecDll():
   ...
   dllObj.SpVecAddSatFrFields.argtypes = [c_double * 3, c_double * 3, c_char, c_int, c_char_p, c_char_p, c_int, c_int, c_double, c_double, c_double, c_char_p]
   ...
   dllObj.SpVecAddSatFrFieldsML.argtypes = [c_double * 3, c_double * 3, c_char, c_int, c_char_p, c_char_p, c_int, c_int, c_double, c_double, c_double, c_char_p, c_longlong_p]
   ...
   dllObj.SpVecUpdateSatFrFields.argtypes = [c_longlong, c_double * 3, c_double * 3, c_char, c_char_p, c_int, c_int, c_double, c_double, c_double, c_char_p]
   ...
   dllObj.SpVecGetAllFields.argtypes = [c_longlong, c_double * 3, c_double * 3, c_char_p, c_int_p, c_char_p, c_char_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_char_p]
   ...
   dllObj.SpVecParse.argtypes = [c_char_p, c_char_p, c_double * 3, c_double * 3, c_char_p, c_int_p, c_char_p, c_char_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_char_p]
   ...
   dllObj.SpVecFieldsToLines.argtypes = [c_double * 3, c_double * 3, c_char, c_int, c_char_p, c_char_p, c_int, c_int, c_double, c_double, c_double, c_char_p, c_char_p, c_char_p]
