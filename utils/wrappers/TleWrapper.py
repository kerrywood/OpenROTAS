...
def LoadTleDll():
   ...
   dllObj.TleAddSatFrFieldsGP.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int]
   ...
   dllObj.TleAddSatFrFieldsGP2.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_double, c_double]
   ...
   dllObj.TleAddSatFrFieldsGP2ML.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_double, c_double, c_longlong_p]
   ...
   dllObj.TleUpdateSatFrFieldsGP.argtypes = [c_longlong, c_char, c_char_p, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int]
   ...
   dllObj.TleUpdateSatFrFieldsGP2.argtypes = [c_longlong, c_char, c_char_p, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_double, c_double]
   ...
   dllObj.TleAddSatFrFieldsSP.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_double, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int]
   ...
   dllObj.TleAddSatFrFieldsSPML.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_double, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_longlong_p]
   ...
   dllObj.TleUpdateSatFrFieldsSP.argtypes = [c_longlong, c_char, c_char_p, c_double, c_double, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int]
   ...
   dllObj.TleGetAllFieldsGP.argtypes = [c_longlong, c_int_p, c_char_p, c_char_p, c_int_p, c_double_p, c_double_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p]
   ...
   dllObj.TleGetAllFieldsGP2.argtypes = [c_longlong, c_int_p, c_char_p, c_char_p, c_int_p, c_double_p, c_double_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_double_p, c_double_p]
   ...
   dllObj.TleGetAllFieldsSP.argtypes = [c_longlong, c_int_p, c_char_p, c_char_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p]
   ...
   dllObj.TleParseGP.argtypes = [c_char_p, c_char_p, c_int_p, c_char_p, c_char_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p]
   ...
   dllObj.TleParseSP.argtypes = [c_char_p, c_char_p, c_int_p, c_char_p, c_char_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p]
   ...
   dllObj.TleGPFieldsToLines.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_char_p, c_char_p]
   ...
   dllObj.TleGPFieldsToCsv.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_double, c_double, c_int, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_char_p]
   ...
   dllObj.TleSPFieldsToLines.argtypes = [c_int, c_char, c_char_p, c_int, c_double, c_double, c_double, c_double, c_int, c_double, c_double, c_double, c_double, c_double, c_double, c_int, c_char_p, c_char_p]
