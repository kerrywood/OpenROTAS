...
def LoadVcmDll():
   ...
   dllObj.VcmGetAllFields.argtypes = [c_longlong, c_int_p, c_char_p, c_char_p, c_int_p, c_double * 3, c_double * 3, c_char_p, c_int_p, c_int_p, c_char_p, c_char_p, c_char_p, c_char_p, c_char_p, c_double_p, c_double_p, c_double_p, c_double_p, c_int_p, c_int_p, c_double_p, c_double * 5, c_int_p, c_char_p, c_char_p, c_char_p, c_char_p, c_char_p, c_char_p, c_double_p, c_double_p, c_double_p]
